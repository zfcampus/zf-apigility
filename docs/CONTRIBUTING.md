...
[create a proposal](https://github.com/zfcampus/zf-apigility/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git://github.com/zfcampus/zf-apigility.git
  $ cd zf-apigility
  ```
...
2. Fork the repository (https://github.com/zfcampus/zf-apigility)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/zf-apigility.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/zf-apigility.git
